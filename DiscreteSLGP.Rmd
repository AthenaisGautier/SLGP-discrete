...
save(df, file="./res_synth/case2_seq/compiled_notrend.RData")
```

```{r SLGP_visu_seq, message=FALSE, warning=FALSE}
load(file="./res_synth/case2_seq/compiled_notrend.RData")
...
save(df, file="./res_synth/case2_seq/compiled_trend.RData")
```


```{r SLGP_visu_seq2trend, message=FALSE, warning=FALSE}
load(file="./res_synth/case2_seq/compiled_trend.RData")
